...
import { tshirts, statistics } from "../constants"
import { Button, TshirtCard } from "../components"

import { arrowRight } from "../assets/icons"
import { tshirt1 } from "../assets/images";

export default function Hero() {
  const [ tshirtImg, setTshirtImg ] = useState(tshirt1)
    ...
    <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full  max-xl:padding-x pt-28'>
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold'>
          ...
          <br/>
          <span className='text-coral-red inline-block mt-3'>RSP</span> T-Shirt
        </h1>
